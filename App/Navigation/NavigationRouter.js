        ...
        return(
            <Router>
                <Scene key = "root">
                    ...
                    <Scene initial={true} onEnter={()=>this.onEnter(true, true, 'Popular Food')} key = "PopularCategoryScreen" component = {PopularCategoryScreen} title = "PopularCategoryScreen" hideNavBar={true}  />
                </Scene>
            </Router>
        );
    }
